  ...
  return (
    <NativeBaseProvider>
        <VStack width="100%" height="100%">
          <Box   height="62%" width="100%" style={{borderBottomEndRadius:50}}  bgColor="black">
            <ImageBackground blurRadius={2}   style={{flex:1,borderBottomEndRadius:50}}   imageStyle={{opacity: 0.6}} source={Therapy_session} resizeMode='cover' >
